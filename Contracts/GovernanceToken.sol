...
interface IBridgeable {
    function bridgeTransfer(address to, uint256 amount, uint256 sourceChainId, bytes32 nonce) external;
    function mint(address to, uint256 amount, uint256 chainId) external;
}
    ...
    IBridgeable
{
    ...
    function mint(address to, uint256 amount, uint256 chainId) external override whenNotPaused nonReentrant {
    ...
    function bridgeTransfer(
        ...
        bytes32 nonce
    ) external override whenNotPaused whenBridgeNotPaused nonReentrant {
